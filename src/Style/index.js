...
export const CardButton = styled.div`
    ...
    background: ${props => props.bgColor || "#fff"};
    height: ${props => props.size === "small" ? "50px" : props.size === "md" ? "100px": props.size === "high" ? "200px" : "36px"};
    width: ${props => props.size === "small" ? "50px" : props.size === "md" ? "100px": props.size === "high" ? "200px" : "36px"};
    border-radius: 5px;
...
export const Container = styled.div`
    ...
    height: ${props => props.h};
    ${props => props.overflow ? `overflow: ${props.overflow};` : null};
    ${props => props.shadow ? "box-shadow: 0px 0px 10px .5px rgba(0, 0, 0, 0.1);" : null};
`;
...
export const MaskInput = styled(MaskedInput)`
    ...
    ${props => props.bgless ? "background: transparent" : "background: #e6e6e6;"};
...
export const Input = styled.input`
    ...
    &:focus {
        ${props => props.borderfocus ? props.borderfocus : "border: 1px solid #999;"};
        border-radius: 4px;
    }
`;
...
export const ButtonDefault = styled.button`
    ...
    flex-direction: row;
    align-items: center;
    font-size: ${props => props.size === "small" ? "16px" : props.size === "md" ? "20px" : props.size === "high" ? "26px" : "20px"};
    background: ${props => props.tp === "success" ? "#2eb82e" : props.tp === "warn" ? "#ff0000" : props.tp === "action" ? "#1a75ff" : "#999"};
    height: ${props => props.size === "small" ? "28px" : props.size === "md" ? "36px" : props.size === "high" ? "48px" : "36px"};
    border-radius: 5px;
    border: 0px;
    margin: 0PX 10px;
    padding: 5px 10px;
    ...
    font-weight: bold;
    &:hover {
        background: ${props => props.tp === "success" ? "#248f24" : props.tp === "warn" ? "#b30000" : props.tp === "action" ? "#0052cc" : "#666"};
...
export const Table = styled.table`
    ...
    thead th {
        ${props => props.titlenoborder ? "border: 0" : "border-bottom: 1px solid #eee"};
    }
    thead th {
